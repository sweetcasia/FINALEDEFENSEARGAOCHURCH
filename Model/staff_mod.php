...
public function getScheduleDetails($baptismfill_id = null, $confirmationfill_id = null, $defuctom_id = null, $weddingffill_id = null, $announcement_id = null, $request_id = null) {
    ...
    // Dynamically bind parameters for each of the fields
    $types = 'iiiiii'; // The types for binding (all integers in this case)
    $params = [$baptismfill_id, $confirmationfill_id, $defuctom_id, $weddingffill_id, $announcement_id, $request_id];
...
public function insertMassAppointment($payableAmount,$massbaptismfillId = null ,$massweddingffill_id = null ) {

...
/* Hover color for icons */
  ...
  Don’t have an account? <a href="#" style="font-size: 15px!important;" class="signuphover" id="sign-up-signbutton">Register here!</a>
</div>           
          </form>
 ...
 <label for="month">Date of Birth</label>
  ...
  <div  style="margin-top: -10px;"class="input_group">
  ...
  <div class="error" id="valid_id_error"></div>
    ...
    <i class="uil uil-phone"></i>    <div class="error" id="phone_error"></div>
          ...
          <i class="uil uil-eye-slash pw_hide"></i>
            ...
            <div class="login_signup">Already have an account? <a class="signuphover"href="#" id="sign-in-signbutton">Login Account</a></div>
...
function showTooltip(event, message) {
  ...
  const tooltipElements = document.querySelectorAll('.tooltip-trigger'); // Add the class 'tooltip-trigger' to any element that should show a tooltip
  tooltipElements.forEach(element => {
    element.addEventListener('mouseenter', (event) => {
      showTooltip(event, 'This is a tooltip message'); // Customize the message as needed
    });
  });

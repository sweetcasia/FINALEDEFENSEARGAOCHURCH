...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Enter Middlename" value="<?php echo $middlename; ?>" readonly/>
                ...
                <input type="hidden" id="fullname" name="fullname" value="<?php echo $pendingItem['fullname'] ?? ''; ?>" readonly/>
            <div class="form-group">
                <label for="address">Address</label>
                <textarea class="form-control" id="address" name="c_address" placeholder="Enter Address"readonly><?php echo $pendingItem['c_address'] ?? ''; ?></textarea>
            ...
            <div class="form-group">
                    ...
                    <div class="d-flex">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault1" value="Male" readonly<?php echo (isset($pendingItem['c_gender']) && $pendingItem['c_gender'] == 'Male') ? 'checked' : ''; ?> />
                            <label class="form-check-label" for="flexRadioDefault1">Male</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="flexRadioDefault2" value="Female" readonly<?php echo (isset($pendingItem['c_gender']) && $pendingItem['c_gender'] == 'Female') ? 'checked' : ''; ?> />
    ...
    <?php endfor; ?>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pbirth" name="name_of_church" placeholder="Enter Name Of Church"value="<?php echo $pendingItem['name_of_church'] ?? ''; ?>" readonly />
    ...
    <?php endfor; ?>
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="parents_residence" name="permission_to_confirm" placeholder="Enter Permission to Confirm"readonly><?php echo $pendingItem['permission_to_confirm'] ?? ''; ?></textarea>
                <span class="error" id="parentsResidenceError"></span>
            </div>
            <div class="form-group">
                <label for="godparents">Church Address</label>
                <textarea class="form-control" id="godparents" name="church_address" placeholder="Enter Church Address"readonly><?php echo $pendingItem['church_address'] ?? ''; ?></textarea>

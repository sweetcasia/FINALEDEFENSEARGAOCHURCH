...
$seminarReports = $userManager->generateSeminarReport('MassBaptism');  
$speaker = $seminarReports ? $seminarReports[0]['speaker'] : 'N/A';
?>
...
<body>
    ...
    <h2 style="text-align: center;">Mass Baptism Seminar Report</h2>
    <h3 style="text-align: center;">Speaker: <?php echo htmlspecialchars($speaker); ?></h3>

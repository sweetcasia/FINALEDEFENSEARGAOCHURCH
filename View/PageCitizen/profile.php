...
.responsive-container-block {
  ...
  <div class="col-md-4 d-flex justify-content-center">
    <div class="card p-3 d-flex align-items-center" onclick="window.location.href='history.php';" style="cursor: pointer;">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="icon-wrapper d-flex justify-content-center align-items-center" style="background-color: #007bff; border-radius: 50%; width: 60px; height: 60px;">
          <i class="fa-solid fa-calendar text-white" style="font-size: 2rem;"></i>
        </div>
        <!-- Text -->
        <div>
  ...
  <div class="col-md-4 d-flex justify-content-center">
    <div class="card p-3 d-flex align-items-center" onclick="window.location.href='seminar.php';" style="cursor: pointer;">
      ...
      <div class="d-flex align-items-center">
        <!-- Icon with Background -->
        <div class="icon-wrapper d-flex justify-content-center align-items-center" style="background-color: #28a745; border-radius: 50%; width: 60px; height: 60px;">
          <i class="fa-solid fa-calendar-days text-white" style="font-size: 2rem;"></i>
        </div>
        <!-- Text -->
        <div>
  ...
  <div class="col-md-4 d-flex justify-content-center">
    <div class="card p-3 d-flex align-items-center" onclick="window.location.href='another-page.php';" style="cursor: pointer;">
      ...
      <div class="d-flex align-items-center">
        <!-- Icon with Background -->
        <div class="icon-wrapper d-flex justify-content-center align-items-center" style="background-color: #ffc107; border-radius: 50%; width: 60px; height: 60px;">
          <i class="fa-solid fa-calendar-check text-white" style="font-size: 2rem;"></i>
        </div>
        <!-- Text -->
        <div>

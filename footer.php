...
<div class="col-md-6 col-lg-6 col-xl-5 d-flex justify-content-center">
    <div class="footer-item text-center">
        <a class="p-0 footer-logo" >
            <img src="View/img/argaochurch.png" alt=""  />
        </a>
                    ...
                    <div class="row g-3">
                        <div class="d-flex align-items-center">
                            <div class="text-container">
                                ...
                                <ul class="mb-0 text-white" style="list-style-type: none; padding-left: 0;">
                                    <li><a href="View/PageLanding/Baptismal.php" class="text-white">Baptism</a></li>
                                    <li><a href="View/PageLanding/Confirmation.php" class="text-white">Confirmation</a></li>
                                    <li><a href="View/PageLanding/Wedding.php" class="text-white">Wedding</a></li>
                                    <li><a href="View/PageLanding/Funeral.php" class="text-white">Funeral</a></li>
                                    <li><a href="View/PageLanding/requestform.php" class="text-white">Request Form</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
